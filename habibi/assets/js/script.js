...
-------------------------------------------*/
   ...
   -------------------------------------------*/
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2024-09-22 09:30:00', function (event) {
            var $this = $(this).html(event.strftime(''
                ...
                + '<div class="box"><div><div class="time">%M</div> <span>Minutes</span> </div></div>'
                + '<div class="box"><div><div class="time">%S</div> <span>Secondes</span> </div></div>'));
        });
    }
    /*------------------------------------------
        = COUNTDOWN CLOCK
